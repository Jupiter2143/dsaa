...
主窗口的左上角的工具栏有两项，分别为“文件”和“帮助”。用户可以在文件一栏中选择从本地路径打开新的图片，保存当前版本的图片和关闭窗口。
![alt text](image-3.png)![alt text](image-4.png)
用户在帮助一栏的“关于”中可以查看本项目的作者、版本信息和同步至github的网址，在“贴士和技巧”中查看对页面各按钮及功能的使用说明。
...
按鼠标左键绘制出的套索对应想要保护区域，显示为红色。按鼠标右键绘制出的套索对应想要删除的区域，显示为绿色。用户点击“确定”后，“套索工具”按钮右侧的对勾会被程序自动勾选。这个对勾不被勾选时，用户无法绘制套索。用户点击“确定”后，已绘制出的区域会生效，并作用于用户接下来在上一个模块中做的缩图和扩图操作。用户点击“取消区域”后，会弹出弹窗如下，之前生效的区域会变为无效，不会影响接下来对图片的处理。
![alt text](image-8.png)
如果用户在没有先点击“套索工具”的前提下点击“确定”，会弹出提示弹窗如下，且不进行其他记录。
